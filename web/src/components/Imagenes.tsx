    ...
    return (
        <div>
            ...
            <div className="w-full bg-gray-100 ">
                ...
                >
                    {ImagenMostrar.map((ruta, index) => (
                        <SwiperSlide key={index}>
                            <img src={ruta} className="w-full h-48 object-cover rounded-md" alt={`Vista de ${dato.nombre} ${index + 1}`} />
                ...
                <div className="custom-pagination !static flex justify-center mt-3"></div>
            </div>
        </div>
    );
}